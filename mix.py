...
class MIXCluster():
    ...
    对基金进行聚类
    '''
    def __init__(self, path="data/mix.xlsx", k=120, iter=1000, interval=0.01):
        self.path = path
        self.k = k
        self.iter = iter
    ...
    def get_sim(self):
        ...
        valid_column = ['基金简称', '近1周', '近1月', '近3月', '近6月', '近1年', '近2年', '近3年', '今年来', '成立来',
    ...
    def plot_pic(self, y_list, names, cluster):
        x = ['近1周', '近1月', '近3月', '近6月', '近1年', '近2年', '近3年', '今年来', '成立来', '2020-02-10至2021-03-09', '2020-03-11至2021-06-15']
        plt.title('指数型')  # 折线图标题
        plt.xlabel('指标')  # x轴标题
        plt.ylabel('值')  # y轴标题
        for item in y_list:
...
if __name__=='__main__':
    # app.run()
    clusters, sim_result = MIXCluster(path="data/mix.xlsx", k=120, iter=100, interval=0.1).main(plot=False)
    print(clusters)
    print(sim_result)
    print("聚类结束！")
