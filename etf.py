...
class ETFCluster():
    ...
    对基金进行聚类
    '''
    def __init__(self, path="data/etf.xlsx", k=120, iter=1000, interval=0.01):
        self.path = path
        self.k = k
        self.iter = iter
...
if __name__=='__main__':
    # app.run()
    clusters, sim_result = ETFCluster(path="data/etf.xlsx", k=120, iter=100, interval=0.01).main(plot=True)
    print(clusters)
    print(sim_result)
    print("聚类结束！")
